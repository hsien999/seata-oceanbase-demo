...
public class TIMESTAMP extends Datum implements Serializable
{
    ...
    public static String toString(final byte[] bytes) {
        ...
        return toString(i, month, day, hour, minute, second, nanos, bytes[11], null);
    }
    
    public static String toString(final int year, final int month, final int day, final int hour, final int minute, final int second, final int nanos, final int scale, final String timezone) {
    ...
    private static String toStr(final int temp) {
