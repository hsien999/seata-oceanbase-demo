...
public class INTERVALDS extends Datum
{
    ...
    public static byte[] toBytes(final String var) {
        ...
        final byte[] intervaldsBytes = new byte[14];
        ...
        intervaldsBytes[13] = (byte)INTERVALDS.MAXLEADPREC;
    ...
    public static String toString(final byte[] data) {
        ...
        final String format = String.format("%%d %%d:%%d:%%d.%%0%dd", fractional_second_scale);
