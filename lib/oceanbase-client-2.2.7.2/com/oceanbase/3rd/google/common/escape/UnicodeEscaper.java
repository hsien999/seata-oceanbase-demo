...
package com.oceanbase.3rd.google.common.escape;
...
public abstract class UnicodeEscaper extends Escaper
{
    ...
    protected static int codePointAt(final CharSequence seq, int index, final int end) {
        ...
        if (c1 > '\udbff') {
            ...
            throw new IllegalArgumentException(new StringBuilder(88 + value.length()).append("Unexpected low surrogate character '").append(c3).append("' with value ").append((int)i).append(" at index ").append(j).append(" in '").append(value).append("'").toString());
        }
        if (index == end) {
            return -c1;
        }
        ...
        throw new IllegalArgumentException(new StringBuilder(89 + value2.length()).append("Expected low surrogate but got char '").append(c4).append("' with value ").append((int)k).append(" at index ").append(l).append(" in '").append(value2).append("'").toString());
    }
