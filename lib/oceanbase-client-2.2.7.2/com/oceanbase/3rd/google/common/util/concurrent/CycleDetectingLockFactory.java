...
import com.oceanbase.3rd.google.common.collect.MapMaker;
...
public class CycleDetectingLockFactory
{
    ...
    private static class LockGraphNode
    {
        ...
        void checkAcquiredLock(final Policy policy, final LockGraphNode acquiredLock) {
            ...
            final String original = "Attempted to acquire multiple locks with the same rank ";
            final String value = String.valueOf(acquiredLock.getLockName());
            Preconditions.checkState(expression, (Object)((value.length() != 0) ? original.concat(value) : new String(original)));
