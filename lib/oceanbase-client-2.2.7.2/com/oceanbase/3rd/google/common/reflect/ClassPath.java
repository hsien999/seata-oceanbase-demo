...
package com.oceanbase.3rd.google.common.reflect;
...
import com.oceanbase.3rd.google.common.collect.ImmutableSortedSet;
...
import com.oceanbase.3rd.google.common.collect.FluentIterable;
import java.io.IOException;
import java.util.Iterator;
import java.net.URI;
import java.util.Map;
import com.oceanbase.3rd.google.common.collect.ImmutableSet;
import com.oceanbase.3rd.google.common.base.Splitter;
            ...
            if (classpathAttribute != null) {
                for (final String path : ClassPath.CLASS_PATH_ATTRIBUTE_SEPARATOR.split(classpathAttribute)) {
                    ...
                    try {
                        ...
                        access$100.warning((value.length() != 0) ? original.concat(value) : new String(original));
                        continue;
                    }
                    builder.add(uri);
                }
