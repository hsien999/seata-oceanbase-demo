...
public class FinalizableReferenceQueue implements Closeable
{
    ...
    private static final String FINALIZER_CLASS_NAME = "com.oceanbase.3rd.google.common.base.internal.Finalizer";
    ...
    static class SystemLoader implements FinalizerLoader
    {
        ...
        public Class<?> loadFinalizer() {
            ...
            if (systemLoader != null) {
                try {
                    return systemLoader.loadClass("com.oceanbase.3rd.google.common.base.internal.Finalizer");
                }
    ...
    static class DecoupledLoader implements FinalizerLoader
    {
        ...
        public Class<?> loadFinalizer() {
            try {
                ...
                return finalizerLoader.loadClass("com.oceanbase.3rd.google.common.base.internal.Finalizer");
            }
            catch (Exception e) {
        ...
        URL getBaseUrl() throws IOException {
            final String finalizerPath = String.valueOf("com.oceanbase.3rd.google.common.base.internal.Finalizer".replace('.', '/')).concat(".class");
            ...
            if (!urlString.endsWith(finalizerPath)) {
                final String original = "Unsupported path style: ";
                final String value = String.valueOf(urlString);
                throw new IOException((value.length() != 0) ? original.concat(value) : new String(original));
            }
    ...
    static class DirectLoader implements FinalizerLoader
    {
        ...
        public Class<?> loadFinalizer() {
            try {
                return Class.forName("com.oceanbase.3rd.google.common.base.internal.Finalizer");
            }
