...
package com.oceanbase.3rd.google.common.base.internal;
...
public class Finalizer implements Runnable
{
    ...
    private static final String FINALIZABLE_REFERENCE = "com.oceanbase.3rd.google.common.base.FinalizableReference";
    ...
    public static void startFinalizer(final Class<?> finalizableReferenceClass, final ReferenceQueue<Object> queue, final PhantomReference<Object> frqReference) {
        if (!finalizableReferenceClass.getName().equals("com.oceanbase.3rd.google.common.base.FinalizableReference")) {
