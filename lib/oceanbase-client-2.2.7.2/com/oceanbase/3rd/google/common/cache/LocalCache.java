...
import com.oceanbase.3rd.google.common.collect.AbstractSequentialIterator;
import com.oceanbase.3rd.google.common.base.Function;
import com.oceanbase.3rd.google.common.util.concurrent.Futures;
import com.oceanbase.3rd.google.common.util.concurrent.SettableFuture;
import java.lang.ref.Reference;
import java.util.concurrent.Future;
import com.oceanbase.3rd.google.common.util.concurrent.Uninterruptibles;
import com.oceanbase.3rd.google.common.util.concurrent.MoreExecutors;
import com.oceanbase.3rd.google.common.util.concurrent.ListenableFuture;
import java.util.concurrent.atomic.AtomicInteger;
import javax.annotation.concurrent.GuardedBy;
import java.util.concurrent.locks.ReentrantLock;
import java.lang.ref.SoftReference;
import java.lang.ref.WeakReference;
import com.oceanbase.3rd.google.common.collect.ImmutableSet;
import java.util.AbstractQueue;
import java.lang.ref.ReferenceQueue;
import com.oceanbase.3rd.google.common.annotations.GwtIncompatible;
import java.util.concurrent.atomic.AtomicReferenceArray;
import java.util.concurrent.TimeUnit;
import com.oceanbase.3rd.google.common.util.concurrent.ExecutionError;
import com.oceanbase.3rd.google.common.util.concurrent.UncheckedExecutionException;
import com.oceanbase.3rd.google.common.base.Stopwatch;
import com.oceanbase.3rd.google.common.collect.Sets;
import java.util.Iterator;
import com.oceanbase.3rd.google.common.collect.Maps;
import com.oceanbase.3rd.google.common.collect.ImmutableMap;
import java.util.concurrent.ExecutionException;
import com.oceanbase.3rd.google.common.primitives.Ints;
import java.util.logging.Level;
import com.oceanbase.3rd.google.common.base.Preconditions;
import com.oceanbase.3rd.google.common.annotations.VisibleForTesting;
import java.util.concurrent.ConcurrentLinkedQueue;
import java.util.Map;
import java.util.Collection;
import java.util.Set;
import javax.annotation.Nullable;
import com.oceanbase.3rd.google.common.base.Ticker;
