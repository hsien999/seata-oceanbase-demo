...
public class JDBC4ClientInfoProviderSP implements JDBC4ClientInfoProvider
{
    ...
    public synchronized void initialize(final Connection conn, final Properties configurationProps) throws SQLException {
        final String identifierQuote = conn.getMetaData().getIdentifierQuoteString();
        ...
        this.setClientInfoSp = ((com.alipay.oceanbase.jdbc.Connection)conn).clientPrepareStatement("CALL " + identifierQuote + catalog + identifierQuote + "." + identifierQuote + setClientInfoSpName + identifierQuote + "(?, ?)");
        this.getClientInfoSp = ((com.alipay.oceanbase.jdbc.Connection)conn).clientPrepareStatement("CALL" + identifierQuote + catalog + identifierQuote + "." + identifierQuote + getClientInfoSpName + identifierQuote + "(?)");
        this.getClientInfoBulkSp = ((com.alipay.oceanbase.jdbc.Connection)conn).clientPrepareStatement("CALL " + identifierQuote + catalog + identifierQuote + "." + identifierQuote + getClientInfoBulkSpName + identifierQuote + "()");
    }
