...
{
    protected static final String DATA_SOURCE_CLASS_NAME = "com.alipay.oceanbase.jdbc.jdbc2.optional.MysqlDataSource";
    protected static final String POOL_DATA_SOURCE_CLASS_NAME = "com.alipay.oceanbase.jdbc.jdbc2.optional.MysqlConnectionPoolDataSource";
    protected static final String XA_DATA_SOURCE_CLASS_NAME = "com.alipay.oceanbase.jdbc.jdbc2.optional.MysqlXADataSource";
    ...
    public Object getObjectInstance(final Object refObj, final Name nm, final Context ctx, final Hashtable<?, ?> env) throws Exception {
        ...
        if (className != null && (className.equals("com.alipay.oceanbase.jdbc.jdbc2.optional.MysqlDataSource") || className.equals("com.alipay.oceanbase.jdbc.jdbc2.optional.MysqlConnectionPoolDataSource") || className.equals("com.alipay.oceanbase.jdbc.jdbc2.optional.MysqlXADataSource"))) {
