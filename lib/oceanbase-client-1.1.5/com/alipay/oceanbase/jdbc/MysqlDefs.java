...
public final class MysqlDefs
{
    ...
    static final int FIELD_TYPE_UROWID = 209;
    static final int FIELD_TYPE_OB_BLOB = 210;
    static final int FIELD_TYPE_OB_CLOB = 211;
    ...
    public static final int FIELD_TYPE_CURSOR = 163;
