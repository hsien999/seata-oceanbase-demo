...
{
    public JDBC4MultiHostMySQLConnection(final MultiHostConnectionProxy proxy) throws SQLException {
        super(proxy);
    }
    ...
    private JDBC4Connection getJDBC4Connection() {
        return (JDBC4Connection)this.getThisAsProxy().currentConnection;
    }
