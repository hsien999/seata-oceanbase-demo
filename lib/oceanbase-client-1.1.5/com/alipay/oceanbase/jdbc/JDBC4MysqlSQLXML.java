...
public class JDBC4MysqlSQLXML implements SQLXML
{
    ...
    @Override
    public synchronized <T extends Source> T getSource(final Class<T> clazz) throws SQLException {
        this.checkClosed();
        this.checkWorkingWithResult();
        ...
        if (clazz.equals(DOMSource.class)) {
            try {
                ...
                builderFactory.setFeature(JDBC4MysqlSQLXML.DDD, true);
    ...
    static {
        JDBC4MysqlSQLXML.DDD = "http://apache.org/xml/features/disallow-doctype-decl";
    }
