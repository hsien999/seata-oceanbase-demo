...
public interface ConnectionProperties
{
    ...
    boolean getUseObChecksum();
    
    boolean getUseOceanBaseProtocolV20();
    ...
    void setCallableStatementCacheSize(final int p0) throws SQLException;
    ...
    void setConnectTimeout(final int p0) throws SQLException;
    ...
    void setInitialTimeout(final int p0) throws SQLException;
    ...
    void setMaxQuerySizeToLog(final int p0) throws SQLException;
    
    void setMaxReconnects(final int p0) throws SQLException;
    
    void setMaxRows(final int p0) throws SQLException;
    
    void setMetadataCacheSize(final int p0) throws SQLException;
    ...
    void setPacketDebugBufferSize(final int p0) throws SQLException;
    
    void setParanoid(final boolean p0);
    
    void setPedantic(final boolean p0);
    
    void setPreparedStatementCacheSize(final int p0) throws SQLException;
    
    void setPreparedStatementCacheSqlLimit(final int p0) throws SQLException;
    ...
    void setQueriesBeforeRetryMaster(final int p0) throws SQLException;
    
    void setReconnectAtTxEnd(final boolean p0);
    
    void setRelaxAutoCommit(final boolean p0);
    
    void setReportMetricsIntervalMillis(final int p0) throws SQLException;
    ...
    void setSecondsBeforeRetryMaster(final int p0) throws SQLException;
    
    void setServerTimezone(final String p0);
    
    void setSessionVariables(final String p0);
    
    void setSlowQueryThresholdMillis(final int p0) throws SQLException;
    
    void setSocketFactoryClassName(final String p0);
    
    void setSocketTimeout(final int p0) throws SQLException;
    
    void setStrictFloatingPoint(final boolean p0);
    
    void setStrictUpdates(final boolean p0);
    
    void setSupportLobLocator(final boolean p0);
    ...
    void setUseObChecksum(final boolean p0);
    
    void setUseOceanBaseProtocolV20(final boolean p0);
    ...
    void setNoTimezoneConversionForDateType(final boolean p0);
    
    boolean getCacheDefaultTimezone();
    
    void setCacheDefaultTimezone(final boolean p0);
    ...
    void setCallableStmtCacheSize(final int p0) throws SQLException;
    
    int getCallableStmtCacheSize();
    
    void setPrepStmtCacheSize(final int p0) throws SQLException;
    
    int getPrepStmtCacheSize();
    
    void setPrepStmtCacheSqlLimit(final int p0) throws SQLException;
    ...
    void setResultSetSizeThreshold(final int p0) throws SQLException;
    
    int getNetTimeoutForStreamingResults();
    
    void setNetTimeoutForStreamingResults(final int p0) throws SQLException;
    ...
    void setTcpRcvBuf(final int p0) throws SQLException;
    
    int getTcpSndBuf();
    
    void setTcpSndBuf(final int p0) throws SQLException;
    
    int getTcpTrafficClass();
    
    void setTcpTrafficClass(final int p0) throws SQLException;
    ...
    void setSlowQueryThresholdNanos(final long p0) throws SQLException;
    ...
    void setLargeRowSizeThreshold(final String p0) throws SQLException;
    ...
    void setIncludeThreadDumpInDeadlockExceptions(final boolean p0);
    
    boolean getIncludeThreadNamesAsStatementComment();
    
    void setIncludeThreadNamesAsStatementComment(final boolean p0);
    ...
    void setSendFractionalSeconds(final boolean p0);
    
    int getSelfDestructOnPingSecondsLifetime();
    
    void setSelfDestructOnPingSecondsLifetime(final int p0) throws SQLException;
    
    int getSelfDestructOnPingMaxOperations();
    
    void setSelfDestructOnPingMaxOperations(final int p0) throws SQLException;
    ...
    void setLoadBalanceBlacklistTimeout(final int p0) throws SQLException;
    
    void setRetriesAllDown(final int p0) throws SQLException;
    ...
    void setLoadBalancePingTimeout(final int p0) throws SQLException;
    ...
    void setLoadBalanceHostRemovalGracePeriod(final int p0) throws SQLException;
    
    int getLoadBalanceHostRemovalGracePeriod();
    
    void setLoadBalanceAutoCommitStatementThreshold(final int p0) throws SQLException;
    ...
    void setAuthenticationPlugins(final String p0);
    
    String getAuthenticationPlugins();
    
    void setDisabledAuthenticationPlugins(final String p0);
    
    String getDisabledAuthenticationPlugins();
    
    void setDefaultAuthenticationPlugin(final String p0);
    
    String getDefaultAuthenticationPlugin();
    
    void setParseInfoCacheFactory(final String p0);
    
    String getParseInfoCacheFactory();
    
    void setServerConfigCacheFactory(final String p0);
    
    String getServerConfigCacheFactory();
    
    void setDisconnectOnExpiredPasswords(final boolean p0);
    
    boolean getDisconnectOnExpiredPasswords();
    
    boolean getAllowMasterDownConnections();
    
    void setAllowMasterDownConnections(final boolean p0);
    
    boolean getAllowSlaveDownConnections();
    
    void setAllowSlaveDownConnections(final boolean p0);
    
    boolean getReadFromMasterWhenNoSlaves();
    
    void setReadFromMasterWhenNoSlaves(final boolean p0);
    
    boolean getReplicationEnableJMX();
    
    void setReplicationEnableJMX(final boolean p0);
    
    void setGetProceduresReturnsFunctions(final boolean p0);
    
    boolean getGetProceduresReturnsFunctions();
    
    void setDetectCustomCollations(final boolean p0);
    ...
    void setServerRSAPublicKeyFile(final String p0) throws SQLException;
    
    boolean getAllowPublicKeyRetrieval();
    
    void setAllowPublicKeyRetrieval(final boolean p0) throws SQLException;
    
    void setDontCheckOnDuplicateKeyUpdateInSQL(final boolean p0);
    
    boolean getDontCheckOnDuplicateKeyUpdateInSQL();
    
    void setSocksProxyHost(final String p0);
    
    String getSocksProxyHost();
    
    void setSocksProxyPort(final int p0) throws SQLException;
    
    int getSocksProxyPort();
    
    boolean getReadOnlyPropagatesToServer();
    
    void setReadOnlyPropagatesToServer(final boolean p0);
    
    String getEnabledSSLCipherSuites();
    
    void setEnabledSSLCipherSuites(final String p0);
    
    boolean getEnableEscapeProcessing();
    
    void setEnableEscapeProcessing(final boolean p0);
    
    boolean getAllowAlwaysSendParamTypes();
    
    void setAllowAlwaysSendParamTypes(final boolean p0);
    
    boolean getUseFormatExceptionMessage();
    
    void setUseFormatExceptionMessage(final boolean p0);
    
    int getComplexDataCacheSize();
    
    void setComplexDataCacheSize(final int p0) throws SQLException;
    
    boolean getCacheComplexData();
    
    void setCacheComplexData(final boolean p0);
    
    void setUseServerPsStmtChecksum(final boolean p0);
    
    boolean getUseServerPsStmtChecksum();
    
    void setUseSqlStringCache(final boolean p0);
    
    boolean getUseSqlStringCache();
}
