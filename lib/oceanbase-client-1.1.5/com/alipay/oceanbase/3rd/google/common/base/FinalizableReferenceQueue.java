...
public class FinalizableReferenceQueue implements Closeable
{
    ...
    private static final String FINALIZER_CLASS_NAME = "com.alipay.oceanbase.3rd.google.common.base.internal.Finalizer";
    ...
    static class SystemLoader implements FinalizerLoader
    {
        ...
        public Class<?> loadFinalizer() {
            ...
            if (systemLoader != null) {
                try {
                    return systemLoader.loadClass("com.alipay.oceanbase.3rd.google.common.base.internal.Finalizer");
                }
    ...
    static class DecoupledLoader implements FinalizerLoader
    {
        ...
        public Class<?> loadFinalizer() {
            try {
                ...
                return finalizerLoader.loadClass("com.alipay.oceanbase.3rd.google.common.base.internal.Finalizer");
            }
            catch (Exception e) {
        ...
        URL getBaseUrl() throws IOException {
            final String finalizerPath = String.valueOf("com.alipay.oceanbase.3rd.google.common.base.internal.Finalizer".replace('.', '/')).concat(".class");
    ...
    static class DirectLoader implements FinalizerLoader
    {
        ...
        public Class<?> loadFinalizer() {
            try {
                return Class.forName("com.alipay.oceanbase.3rd.google.common.base.internal.Finalizer");
            }
