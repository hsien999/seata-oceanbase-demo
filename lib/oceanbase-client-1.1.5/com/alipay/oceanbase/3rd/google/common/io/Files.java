...
import com.alipay.oceanbase.3rd.google.common.base.Splitter;
import java.io.RandomAccessFile;
import java.nio.channels.FileChannel;
import java.nio.MappedByteBuffer;
import com.alipay.oceanbase.3rd.google.common.hash.HashCode;
import com.alipay.oceanbase.3rd.google.common.hash.HashFunction;
...
import java.io.File;
import com.alipay.oceanbase.3rd.google.common.collect.TreeTraverser;
...
public final class Files
{
    ...
    public static File createTempDir() {
        ...
        for (int counter = 0; counter < 10000; ++counter) {
            final File parent = baseDir;
            final String value = String.valueOf(String.valueOf(baseName));
            final File tempDir = new File(parent, new StringBuilder(11 + value.length()).append(value).append(counter).toString());
            if (tempDir.mkdir()) {
                return tempDir;
            }
        }
