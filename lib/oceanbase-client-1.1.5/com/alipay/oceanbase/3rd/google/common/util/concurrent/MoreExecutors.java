...
import com.alipay.oceanbase.3rd.google.common.collect.Queues;
...
public final class MoreExecutors
{
    ...
    public static ThreadFactory platformThreadFactory() {
        ...
        try {
            return (ThreadFactory)Class.forName("com.alipay.oceanbase.3rd.google.appengine.api.ThreadManager").getMethod("currentRequestThreadFactory", (Class<?>[])new Class[0]).invoke(null, new Object[0]);
        }
    ...
    private static boolean isAppEngine() {
        if (System.getProperty("com.alipay.oceanbase.3rd.google.appengine.runtime.environment") == null) {
            return false;
        }
        try {
            return Class.forName("com.alipay.oceanbase.3rd.google.apphosting.api.ApiProxy").getMethod("getCurrentEnvironment", (Class<?>[])new Class[0]).invoke(null, new Object[0]) != null;
        }
